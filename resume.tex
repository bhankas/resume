...
\begin{itemize} \itemsep 1pt
    ...
    \item Built a generic database access API to dynamically and securely update database entries as backoffice operation backbone. This API immediately reduced manual labor and chances or error during last-ditch correction efforts.
    \item Introduced redis as caching layer to reduce database load by 30-60\% for most heavily queried data, including account balances.
