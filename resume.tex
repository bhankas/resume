...
\outline{2}[Doom Emacs]{Doom Emacs}
...
%==== Certifications ====%
\outline{1}[Certifications]{Certifications}
\header{Certifications}
\vspace{1mm}

\outline{2}[SCTS NextGen Expert Java]{SCTS NextGen Expert Java}
\textbf{SCTS NextGen Expert Java} \hfill SEED Infotech, Pune\\
Technologies: Java, Javascript, HTML\\
\vspace*{2mm}

\outline{2}[Embedded Technologies]{Embedded Technologies}
