...
\begin{tabularx}{\textwidth}{ | X | c | }
  \hline
\textbf{Pune University} & \\
Master of Engineering (Electronics) in Digital Systems & \textit{8.48} \\
  \hline

\textbf{Pune University} & \\
Bachelor of Engineering in Electronics \& Telecommunications & \textit{62.5 \%} \\
  \hline

\textbf{HSC} & \textit{59.17\%} \\
  \hline

\textbf{SSC} & \textit{93.07 \%} \\
  \hline
\end{tabularx}
\vspace{2mm}
