...
\begin{itemize} \itemsep 1pt
	...
	\item Experienced software developer with 7 years of experience and Masters in Digital Systems from Savitribai Phule Pune University.
...
\begin{tabularx}{\textwidth}{ | X | X | }
	\hline
	\textbf{Languages/Technologies} & Java, SQL, Bash, Nix, Docker              \\
	\hline
	\textbf{Platforms}              & AWS (EC2, Lambda, Gateway), Linux, NixOS, \\
	\hline
	\textbf{Databases}              & PostgreSQL, SQLite                        \\
	\hline
	\textbf{Libraries/Frameworks}   & jPOS, Spring (Boot), Hibernate            \\
	\hline
\end{tabularx}
\egroup
\vspace{2mm}
...
\outline{2}[Ecommerce]{THG Ingenuity}
\textbf{THG Ingenuity (\href{https://www.thgingenuity.com/}{THG Ingenuity})} \\
\noindent
\begin{tabularx}{\textwidth}{ l l>{\raggedleft\arraybackslash}X}
	% \begin{tabularx}{\textwidth}{ l l l r }
	Product & : \textit{Ecommerce (Logistics)} &                      \\
	Role    & : \textit{Senior Software Engineer}                                                          & Feb 2026 - Till Date \\
\end{tabularx}
\textbf{} \\
\begin{itemize} \itemsep 1pt
	\item THG Ingenuity is an e-commerce platform serving worldwide with in-house technology.
	\item Ownership of Freight systems, tracking all freight shipments via multiple forwarders.
	\item Designed and implemented multiple features for freight estimate optimizations, commercial invoicing and product movement throughout warehouse. 
  \item Automated event schema propagation across repositories to reduce developer actions on aether and cockroachDB schema updates to BigQuery. 
	\item \textbf{Technologies}: Java, Kotlin, Spring Boot, Hibernate, PostgreSQL, GCP, Artemis, RabbitMQ, Kafka 
\end{itemize}

\outline{2}[Unified Payments Interface (UPI), CMS]{Onecard / FPL}
\textbf{FPL Technology (\href{https://www.getonecard.app/}{Onecard})} \\
\noindent
\begin{tabularx}{\textwidth}{ l l>{\raggedleft\arraybackslash}X}
	% \begin{tabularx}{\textwidth}{ l l l r }
	Product & : \textit{\href{https://en.wikipedia.org/wiki/Unified_Payments_Interface}{Unified Payments Interface}} &                      \\
	Role    & : \textit{Senior Software Engineer (Backend)}                                                          & Feb 2023 - Feb 2026 \\
\end{tabularx}
\textbf{} \\
\begin{itemize} \itemsep 1pt
  ...
  \item Designed and implemented complete transaction reconciliation for UPI file processing, including batch processing pipeline, reporting, notifications and SFTP integration for near-complete automation with zero manual intervention required on regular basis.
  ...
  \item Designed and implemented internal framework for dynamically encrypting PII (Personally Identifiable Information) at application level, with zero-downtime key rotation and fine-grained control.
  \item Designed and improved multiple security and compliance frameworks for card data encryption and hashing without impacting existing flows.
  \item Built a generic database access API to dynamically and securely update database entries as backoffice operation backbone.
  \item Introduced {\href{https://github.com/redis/redis}{redis}} as caching layer to reduce database load by 30-60\% for most heavily queried data, including account balances.
  \item Initiated migration of team's monitoring flows from AWS Cloudwatch to Prometheus+Grafana. This stack gave team greater control with fine grained monitoring for nearly every metric necessary, with near-complete automation of monitoring, reducing manual intervention.  
  \item Actively participated and improved agile practices within team, including daily standups, backlog refinement and sprint planning. 
	...
	\item \textbf{Technologies}: Java (8-21), {\href{https://jpos.org/}{jPOS}}, Hibernate, PostgreSQL, AWS, Docker, Prometheus, Micrometer
\end{itemize}
...
\begin{itemize} \itemsep 1pt
	...
	\item Provided incident resolution, platform monitoring and ensuring stability across the stack. Acquired strong understanding of development process, tooling, infrastructure and domain expertise. Developed strong understanding of Agile development methodology.
